...
namespace EnrollmentApplication.Controllers
{
    public class EnrollmentManagerController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "EnrollmentId,StudentId,CourseId,Grade,EnrollmentImgUrl,IsActive,AssignedCampus,EnrollmentSemester,EnrollmentYear")] Enrollment enrollment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "EnrollmentId,StudentId,CourseId,Grade,EnrollmentImgUrl,IsActive,AssignedCampus,EnrollmentSemester,EnrollmentYear")] Enrollment enrollment)
        {
            if (ModelState.IsValid)
            {
